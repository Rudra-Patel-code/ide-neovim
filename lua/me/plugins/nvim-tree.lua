  ...
  function M.config()
    ...
    vim.api.nvim_create_autocmd("ColorScheme", {
      ...
      callback = function()
        ...
        vim.api.nvim_set_hl(0, "NvimTreeNormalNC",    { bg = "#1a1b26" })
        vim.api.nvim_set_hl(0, "NvimTreeEndOfBuffer", { bg = "#1a1b26" })
      end,
    })
    ...
    map("n", "<leader>ef", "<cmd>NvimTreeFindFileToggle<CR>", vim.tbl_extend("force", opts, { desc = "Find Current File" }))
...
vim.defer_fn(function()
  vim.cmd([[
    ...
    highlight! NvimTreeNormalNC guibg=#1a1b26
    highlight! NvimTreeEndOfBuffer guibg=#1a1b26
  ]])
end, 100)
